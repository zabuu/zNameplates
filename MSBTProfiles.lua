...
-- One-time migration snapshot of the regular MSBT account profiles.
-- embedded_msbt.lua copies every profile into zNameplates on first load.
zNameplatesRegularMikSBT_Save = {
	["UserDisabled"] = false,
