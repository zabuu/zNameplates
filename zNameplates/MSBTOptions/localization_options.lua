...
MikSBTOpt.MSG_NORMAL_PREVIEW_TEXT				= "Normal 12345";
MikSBTOpt.MSG_CRIT_PREVIEW_TEXT				= "Critical 12345";
...
MikSBTOpt.SLIDERS = {
 ["Tab1FrameAnimationStepSlider"]	= { Label="Text Speed", Tooltip="Sets travel speed in pixels per second without changing scroll distance."},
 ["Tab1FrameFadeDelaySlider"]		= { Label="Fade Delay", Tooltip="Sets how many seconds text stays fully visible before it starts fading."},
...
MikSBTOpt.FRAMES = {
 ...
 ["MSBTScrollAreaMoverPetIncomingFrame"]	= { Tooltip="Indicates the anchor column for combat events affecting your pet."},
 ["MSBTScrollAreaMoverPetOutgoingFrame"]	= { Tooltip="Indicates the anchor column for combat events caused by your pet."},
}
