pfUI:RegisterModule("gui", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(nil, T["MSBT Floating Combat Text"], nil, nil, "header")
      CreateConfig(U["nameplates"], T["Enable MSBT"], C.nameplates, "msbt_enable", "checkbox")
      CreateConfig(U["nameplates"], T["MSBT X-Offset"], C.nameplates, "msbt_x")
      CreateConfig(U["nameplates"], T["MSBT Y-Offset"], C.nameplates, "msbt_y")
      CreateConfig(U["nameplates"], T["MSBT Scroll Area Height"], C.nameplates, "msbt_height")
      CreateConfig(U["nameplates"], T["MSBT Seconds Before Fade"], C.nameplates, "msbt_fade")
      CreateConfig(U["nameplates"], T["MSBT Text Alignment"], C.nameplates, "msbt_align", "dropdown", pfUI.gui.dropdowns.textalign)
