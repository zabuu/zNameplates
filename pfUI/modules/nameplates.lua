pfUI:RegisterModule("nameplates", function ()
  ...
  -- formatting, colors and fonts; pfUI owns only the per-nameplate placement and
  -- animation frames.
...
nameplates:RegisterEvent("ADDON_LOADED")
  ...
  -- Normally MSBT is already loaded before pfUI. The event also covers manual or
  -- load-on-demand ordering without adding a hard addon dependency.
