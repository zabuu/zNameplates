pfUI:RegisterModule("firstrun", function ()
  ...
  pfUI.firstrun.steps = {}
  -- OCTO_UPDATER_CHAT_SKIP_BEGIN
  if pfUI_config and pfUI_config.disabled and pfUI_config.disabled.chat == "1" then
    pfUI_init = pfUI_init or {}
    pfUI_init["chat_right"] = true
    pfUI_init["chat_position"] = true
    pfUI_init["chat_channels"] = true
  end
  -- OCTO_UPDATER_CHAT_SKIP_END
  ...
  pfUI.firstrun:AddStep("finalize", function()
    ...
    local positions = (pfUI_profiles[pfUI_init.selected_profile or "Default"] or pfUI_profiles["Modern"]).new_module_positions
