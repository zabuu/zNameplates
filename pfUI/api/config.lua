...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("nameplates", nil,           "msbt_enable",      "0")
  pfUI:UpdateConfig("nameplates", nil,           "msbt_x",           "0")
  pfUI:UpdateConfig("nameplates", nil,           "msbt_y",           "8")
  pfUI:UpdateConfig("nameplates", nil,           "msbt_height",      "80")
  pfUI:UpdateConfig("nameplates", nil,           "msbt_fade",        ".5")
  pfUI:UpdateConfig("nameplates", nil,           "msbt_align",       "CENTER")
